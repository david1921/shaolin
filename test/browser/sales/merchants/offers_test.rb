  ...
  module Merchants
    class OffersTest < BrowserTest
      ...
      def test_index
        ...
        sign_in @sales_user
        visit "/sales/merchants/#{@merchant.to_param}/offers"
      ...
      def test_new
        sign_in @sales_user
        visit "/sales/merchants/#{@merchant.to_param}/offers/new"
        save_progress_new_offer_using_test_data
        assert_on_namespaced_merchant_offers_page(:sales, @merchant)
      end

      def test_edit
        offer = create(:offer, merchant: @merchant)
        sign_in @sales_user
        visit "/sales/merchants/#{@merchant.to_param}/offers/#{offer.to_param}/edit"
        click_button 'Submit'
        assert_on_namespaced_offers_page_kia_page(:sales, @merchant)
      end
