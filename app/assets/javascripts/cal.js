/**
	...
	Also note, Sam added a function that allows the Date Picker to close when you click on
	a different part of the screen. In order for that to work though make sure the input
	has the class "date_input"

**/

// don't declare anything out here
...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function(options) {
        ...
        return this.each(function() {
			...
			if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
              ...
              var chosendate = new Date(parseInt(parts[2]), parseInt(parts[1] - 1), parseInt(parts[0]));
	...
	jQuery.fn.simpleDatepicker.formatOutput = function (dateObj) {
		// DANNY MODIFIED THIS LINE TO CONVERT TO UK DATE FORMAT
